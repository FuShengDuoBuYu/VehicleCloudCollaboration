...
# Active Overrides
# =====================
# Use USB camera via OpenCV/V4L2 (e.g., /dev/video0).
CAMERA_TYPE = "CVCAM"
CAMERA_INDEX = 0
IMAGE_W = 160
IMAGE_H = 120
...
# Use Rospbot drivetrain backend instead of Donkey's PCA9685 drivetrain.
DRIVE_TRAIN_TYPE = "ROSPBOT"
ROSPBOT_MAX_SPEED = 180
ROSPBOT_TURN_SCALE = 0.7
ROSPBOT_DEADZONE = 0.02
# Web-only control: disable default joystick path (js0 missing would override web inputs).
